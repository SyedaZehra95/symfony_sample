 ...
 */
final class Version20190322100349 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE spotted_cases ADD spotted_at VARCHAR(100) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE spotted_cases DROP spotted_at');
    }
}

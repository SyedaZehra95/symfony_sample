 ...
 */
final class Version20190328042011 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE unattended ADD emotion VARCHAR(25) DEFAULT NULL');
        $this->addSql('ALTER TABLE spotted_cases ADD emotion VARCHAR(25) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE spotted_cases DROP emotion');
        $this->addSql('ALTER TABLE unattended DROP emotion');
    }
}

 ...
 */
final class Version20190329081143 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE age_distribution DROP CONSTRAINT FK_5BB4EF5464482BF8');
        $this->addSql('ALTER TABLE age_distribution ADD CONSTRAINT FK_5BB4EF5464482BF8 FOREIGN KEY (age_range_id) REFERENCES age_range (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE person_emo_tbl (userid INT NOT NULL, useridconfidence DOUBLE PRECISION NOT NULL, emotion TEXT NOT NULL, emotionconfidence DOUBLE PRECISION NOT NULL, "time" TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL)');
        $this->addSql('CREATE TABLE common_emo_tbl (emotion TEXT NOT NULL, emotionconfidence DOUBLE PRECISION NOT NULL, "time" TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL)');
        ...
        $this->addSql('ALTER TABLE age_distribution DROP CONSTRAINT fk_5bb4ef5464482bf8');
        $this->addSql('ALTER TABLE age_distribution ADD CONSTRAINT fk_5bb4ef5464482bf8 FOREIGN KEY (age_range_id) REFERENCES age_range (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
}

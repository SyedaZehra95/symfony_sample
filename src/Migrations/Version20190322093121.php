 ...
 */
final class Version20190322093121 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE spotted_cases_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE spotted_cases (id INT NOT NULL, case_id VARCHAR(100) DEFAULT NULL, gallery_case VARCHAR(100) DEFAULT NULL, zone VARCHAR(100) DEFAULT NULL, gallery VARCHAR(20) DEFAULT NULL, name VARCHAR(20) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, gender VARCHAR(20) DEFAULT NULL, age VARCHAR(10) DEFAULT NULL, ethnicity VARCHAR(20) DEFAULT NULL, image_base TEXT DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE spotted_cases_id_seq CASCADE');
        ...
        $this->addSql('DROP TABLE spotted_cases');
    }
}

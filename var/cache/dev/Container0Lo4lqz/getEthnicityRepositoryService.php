...
// Returns the private 'App\Repository\EthnicityRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EthnicityRepository.php';

return $this->privates['App\Repository\EthnicityRepository'] = new \App\Repository\EthnicityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

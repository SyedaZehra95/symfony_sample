...
// Returns the private 'App\Repository\UnattendedRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UnattendedRepository.php';

return $this->privates['App\Repository\UnattendedRepository'] = new \App\Repository\UnattendedRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

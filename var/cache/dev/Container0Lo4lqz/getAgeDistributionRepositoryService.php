...
// Returns the private 'App\Repository\AgeDistributionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AgeDistributionRepository.php';

return $this->privates['App\Repository\AgeDistributionRepository'] = new \App\Repository\AgeDistributionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\UserProfileRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserProfileRepository.php';

return $this->privates['App\Repository\UserProfileRepository'] = new \App\Repository\UserProfileRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

...
// Returns the private 'App\Repository\EthnicGroupRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EthnicGroupRepository.php';

return $this->privates['App\Repository\EthnicGroupRepository'] = new \App\Repository\EthnicGroupRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

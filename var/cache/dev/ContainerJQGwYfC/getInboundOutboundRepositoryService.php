...
// Returns the private 'App\Repository\InboundOutboundRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/InboundOutboundRepository.php';

return $this->privates['App\Repository\InboundOutboundRepository'] = new \App\Repository\InboundOutboundRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\UserOTPRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserOTPRepository.php';

return $this->privates['App\Repository\UserOTPRepository'] = new \App\Repository\UserOTPRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));

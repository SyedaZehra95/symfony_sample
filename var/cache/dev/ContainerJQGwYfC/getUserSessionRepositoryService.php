...
// Returns the private 'App\Repository\UserSessionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserSessionRepository.php';

return $this->privates['App\Repository\UserSessionRepository'] = new \App\Repository\UserSessionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

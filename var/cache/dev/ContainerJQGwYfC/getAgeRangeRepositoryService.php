...
// Returns the private 'App\Repository\AgeRangeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AgeRangeRepository.php';

return $this->privates['App\Repository\AgeRangeRepository'] = new \App\Repository\AgeRangeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\SpottedCasesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SpottedCasesRepository.php';

return $this->privates['App\Repository\SpottedCasesRepository'] = new \App\Repository\SpottedCasesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
class __TwigTemplate_ea226b425aadef16692f619bfbc0025a7627f274355a11138bd6246982b25791 extends Twig_Template
{
    private $source;
    ...
    ";
        ...
        ";
            // line 45
            $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "EightPointsGuzzleBundle::debug.html.twig", 45)->display(array_merge($context, ["link" => (isset($context["profiler_url"]) || array_key_exists("profiler_url", $context) ? $context["profiler_url"] : (function () { throw new Twig_Error_Runtime('Variable "profiler_url" does not exist.', 45, $this->source); })()), "status" => (isset($context["status_color"]) || array_key_exists("status_color", $context) ? $context["status_color"] : (function () { throw new Twig_Error_Runtime('Variable "status_color" does not exist.', 45, $this->source); })())]));
            // line 46
            echo "    ";
        }
...
";
    ...
    ";
        // line 72
        $this->loadTemplate("@EightPointsGuzzle/profiler.html.twig", "EightPointsGuzzleBundle::debug.html.twig", 72)->display(array_merge($context, ["collector" => (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new Twig_Error_Runtime('Variable "collector" does not exist.', 72, $this->source); })())]));
...
{% endblock %}
", "EightPointsGuzzleBundle::debug.html.twig", "/Users/say_era/Desktop/smai/vendor/eightpoints/guzzle-bundle/src/Resources/views/debug.html.twig");
    }
}

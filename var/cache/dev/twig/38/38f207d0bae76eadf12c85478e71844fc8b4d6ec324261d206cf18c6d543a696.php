...
class __TwigTemplate_ddb0fd4f87b053b8b57f0b31350e915290fb1cfa3543577f47152029cd93e633 extends Twig_Template
{
    private $source;
    ...
    public function block_page_content($context, array $blocks = [])
    {
        ...
        echo "</h3>
            ...
            <p>";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 12, $this->source); })()), "message", []), "html", null, true);
        echo "</p>
        </div>
    </div>
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new Twig_Error_Runtime('Variable "exception" does not exist.', 18, $this->source); })()), "toarray", []));
        ...
        <div class=\"box box-danger\">
            <div class=\"box-header\">
                ...
                <h3 class=\"box-title\">";
            // line 24
            echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->abbrClass(twig_get_attribute($this->env, $this->source, $context["position"], "class", []));
            echo "</h3>
            </div>
            <div class=\"box-body\">
                ...
                <div class=\"callout callout-danger\">
                    ";
            // line 29
            echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->formatFileFromText(nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["position"], "message", []), "html", null, true)));
            echo "
                </div>
            ...
            // line 49
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["position"], "trace", []));
            foreach ($context['_seq'] as $context["i"] => $context["trace"]) {
                                        ...
                                        <li>
                                            ...
                                            <div class=\"timeline-item\">
                                                <h3 class=\"timeline-header\">
                                                    ";
                // line 60
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["trace"], "file", []), "html", null, true);
                echo "
                                                </h3>
                                                ...
                                                <div class=\"timeline-body\">
                                                    ";
                // line 64
                if (twig_get_attribute($this->env, $this->source, $context["trace"], "function", [])) {
                    // line 65
                    echo "                                                        at
                                                        <strong>
                                                            <abbr title=\"";
                    ...
                    echo "\">";
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["trace"], "short_class", []), "html", null, true);
                    echo "</abbr>
                                                            ";
                    // line 68
                    echo twig_escape_filter($this->env, (twig_get_attribute($this->env, $this->source, $context["trace"], "type", []) . twig_get_attribute($this->env, $this->source, $context["trace"], "function", [])), "html", null, true);
                    echo "
                                                        </strong>
                                                        (";
                    // line 70
                    echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->formatArgs(twig_get_attribute($this->env, $this->source, $context["trace"], "args", []));
                    echo ")
                                                    ";
                }
                // line 72
                echo "
                                                    ";
                // line 73
                if ((((twig_get_attribute($this->env, $this->source, $context["trace"], "file", [], "any", true, true) && twig_get_attribute($this->env, $this->source, $context["trace"], "file", [])) && twig_get_attribute($this->env, $this->source, $context["trace"], "line", [], "any", true, true)) && twig_get_attribute($this->env, $this->source, $context["trace"], "line", []))) {
                    // line 74
                    echo "                                                        ";
                    echo ((twig_get_attribute($this->env, $this->source, $context["trace"], "function", [])) ? ("<br />") : (""));
                    echo "
                                                        in ";
                    // line 75
                    echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->formatFile(twig_get_attribute($this->env, $this->source, $context["trace"], "file", []), twig_get_attribute($this->env, $this->source, $context["trace"], "line", []));
                    echo "&nbsp;
                                                        ";
                    // line 76
                    echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->fileExcerpt(twig_get_attribute($this->env, $this->source, $context["trace"], "file", []), twig_get_attribute($this->env, $this->source, $context["trace"], "line", []));
                    echo "
...
{% endblock %}
", "AdminLTEBundle:Exception:exception_full.html.twig", "/Users/say_era/Desktop/smai/vendor/kevinpapst/adminlte-bundle/Resources/views/Exception/exception_full.html.twig");
    }
}
